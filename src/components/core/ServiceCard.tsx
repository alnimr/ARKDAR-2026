...
export default function ServiceCard({ service }: ServiceCardProps) {
  ...
  const location = service.location[locale as keyof typeof service.location] || service.location.en;
  const description = service.description[locale as keyof typeof service.description] || service.description.en;
  const duration = service.duration[locale as keyof typeof service.duration] || service.duration.en;
  const level = service.level[locale as keyof typeof service.level] || service.level.en;
  const expertName = service.expert.name[locale as keyof typeof service.expert.name] || service.expert.name.en;
