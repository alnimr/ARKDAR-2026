      ...
      <div className="relative overflow-hidden min-h-[400px]">
        ...
        {step === 3 && (
          <div className="animate-fade-in space-y-8">
            ...
            <div className="glass p-8 rounded-3xl space-y-6 max-w-2xl mx-auto border-white/10">
              <div className="grid md:grid-cols-2 gap-6">
        ...
        {step === 4 && (
          <div className="animate-fade-in space-y-8">
            ...
            <div className="grid gap-6 max-w-2xl mx-auto glass p-8 rounded-3xl border-white/10">
