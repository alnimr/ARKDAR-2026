  ...
  return (
    <div className="flex flex-col items-center w-full overflow-x-hidden">
      ...
      <section className="min-h-screen w-full pt-36 pb-24 px-4 md:px-8 flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="glass p-10 md:p-20 rounded-3xl text-center max-w-4xl relative overflow-hidden group animate-fade-up border-2 border-arkdar-crimson/20 shadow-[0_0_40px_rgba(132,5,5,0.1)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map(({ icon: Icon, title, desc }) => (
            <Link 
              key={title} 
              href="/arenas"
              className="glass p-8 rounded-2xl group hover:-translate-y-2 hover:shadow-xl transition-all duration-300 relative overflow-hidden border border-arkdar-crimson/20"
            >
      ...
      <section className="w-full py-28 relative overflow-hidden bg-surface-dark">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="glass-dark p-10 rounded-3xl text-center group relative overflow-hidden border border-arkdar-crimson/30 shadow-2xl">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={r.country}
                className="glass p-10 rounded-3xl flex flex-col items-start gap-4 hover:-translate-y-2 transition-all duration-300 border border-arkdar-crimson/20 shadow-sm hover:shadow-xl"
              >
